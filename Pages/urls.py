...
urlpatterns = [
    ...
    path("Hospital/<Hospital_id>/Dashboard",
    ...
    path("Hospital/<Hospital_id>/Dept/<UID>",
         views.Department, name="Department"),
    path("Hospital/<Hospital_id>/OurPredictions/<UID>",
         views.OurPredictions, name="OurPredictions"),
